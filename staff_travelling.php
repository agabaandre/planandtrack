		...
		<div class="page-wrapper">
          ...
          <div class="card">
                <div class="card-header">
                  ...
                  <div class="row">
                    <div class="col-sm-10">
                      <h6 class="card-title"> <?php echo $activity . ' ; ' . $member_state . ' ; ' . $proposed_start_date . ' ; ' . $proposed_end_date . ' ; ' . $estimated_cost;   ?></h6>
                    </div>
                    <div class="col-sm-2">
                      <button type="button" style="float:right" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#registerstudents">+ Add New Staff</button>
                    </div>
                  </div>
                  <hr>
